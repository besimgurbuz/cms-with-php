                ...
                <ul>
                    <li>
                        ...
                        <div class="form-content">
                            <input type="text" id="partner_name" name="partner_name" value="<?=post('partner_name') ? post('partner_name'): null?>">
                        </div>
                    </li>
                    <li>
                        <label for="partner_url">Partner URL</label>
                        <div class="form-content">
                            <input type="text" id="partner_url" name="partner_url" value="<?=post('partner_url') ? post('partner_url'): null?>">
                        </div>
                    </li>
                    <li>
